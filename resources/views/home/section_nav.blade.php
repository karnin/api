<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" {{--id="side-menu"--}}>
            ...
            <li>
                <a><i class="fa fa-sitemap"></i> <span class="nav-label">项目 </span><span
                            class="fa arrow"></span></a>

                <ul class="nav nav-second-level collapse in">
                    @foreach($nav as $key=>$value)
                        <li>
                            <a >{{ $value['project_name'] }}<span class="fa arrow"></span></a>
                            @if($value['version'])
            ...
            <li>
                <a href="{{ url('errorCode') }}"><i class="fa fa-sitemap"></i> <span class="nav-label">错误码 </span><span
                            class="fa arrow"></span></a>
